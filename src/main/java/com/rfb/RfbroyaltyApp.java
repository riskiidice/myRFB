...
public class RfbroyaltyApp {

    private static final Logger log = LoggerFactory.getLogger(RfbroyaltyApp.class);

    private final Environment env;

    public RfbroyaltyApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes rfbroyalty.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RfbroyaltyApp.class);
